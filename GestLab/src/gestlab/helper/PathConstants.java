...
public class PathConstants {
    ...
    public static final String SERVICE = "http://localhost:8080/RestfulServer/webresources";
    public static final String SERVICE_SSL = "https://localhost:8181/GestLabRestful/webresources";
